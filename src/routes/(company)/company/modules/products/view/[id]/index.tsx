...
export const useGetProductById = routeLoader$<IGetProductById>( async ({ params, cookie, redirect }) => {
  ...
  if ( !isUUID( id ) ) throw redirect( 302, '/company/modules/products' )
...
export default component$( () => {
  ...
  const onImageClick = $( ( id : string ) => {
    nav( `/company/modules/products/product-images/view/${ btoa( id ) }` )
  } )

  const onCategoryClick = $( ( id : string ) => {
    nav( `/company/modules/products/product-categories/view/${ btoa( id ) }` )
  } )

  const onEditClick = $( ( id : string ) => {
    nav( `/company/modules/products/update/${ btoa( id ) }` )
  } )
    ...
    <div class="view__container">
      ...
      <div class="view__container__card">
        ...
        <section class="view__container__card__footer">
          ...
          <Link
            href={ `/company/modules/products/product-images/create/${ btoa( product.id ) }` }
            class="view__link"
          > Add Image </Link>
          <div class="view__images">
            <p> Categories </p>
          ...
          <Link
            href={ `/company/modules/products/product-categories/create/${ btoa( product.id ) }` }
            class="view__link"
          > Add Category </Link>
        </section>
      </div>
