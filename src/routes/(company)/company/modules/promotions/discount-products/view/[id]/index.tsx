...
export default component$( () => {
  ...
  const onCreateCouponsClick = $( ( id: string ) => {
    nav( `/company/modules/promotions/code-promotion-discount-products/create/${ btoa( id ) }` )
  } )

  const onCouponViewClick = $( ( id: string ) => {
    nav( `/company/modules/promotions/code-promotion-discount-products/view/${ btoa( id ) }` )
  } )
