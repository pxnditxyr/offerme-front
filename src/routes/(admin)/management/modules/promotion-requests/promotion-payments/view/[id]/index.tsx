...
import { ManagementPromotionPaymentsService } from '~/services'
import { IGQLErrorResponse, IManagementPromotionPayment } from '~/interfaces'

import styles from './view.styles.css?inline'
import { useModalStatus } from '~/hooks'

export const useGetPromotionPaymentById = routeLoader$<IManagementPromotionPayment | IGQLErrorResponse>( async ({ params, cookie, redirect }) => {
  ...
  const promotionPayment = await ManagementPromotionPaymentsService.promotionPayment({ promotionPaymentId: id, jwt: jwt.value })
