...
export const approvePromotionStatusAction = routeAction$( async ( data, { cookie, fail, params } ) => {
  ...
  const promotionStatus = await ManagementPromotionStatusService.approve({ jwt: jwt.value, statusUpdatePromotionStatusInput: { id, ...data } })
...
export default component$( () => {
  ...
  return (
    <div class="create__container">
      ...
      <h1 class="create__title"> Approve Promotion </h1>
          ...
          <Modal isOpen={ modalStatus.value } onClose={ onCloseModal }>
            {
              ( action.value?.success ) && (
                <span> Promotion Approved Successfully </span>
              )
            }
            {
