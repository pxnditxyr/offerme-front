...
export default component$( () => {
  ...
  const onEditClick = $( ( id: string ) => {
    nav( `/management/modules/promotions/discount-products/update/${ btoa( id ) }` )
  } )

  const onCreateCouponsClick = $( ( id: string ) => {
    nav( `/management/modules/promotions/code-promotion-discount-products/create/${ btoa( id ) }` )
  } )

  const onCouponViewClick = $( ( id: string ) => {
    nav( `/management/modules/promotions/code-promotion-discount-products/view/${ btoa( id ) }` )
  } )
  ...
  return (
    <div class="view__container">
      ...
      <article class="view__container__card">
        ...
        <section class="view__container__card__footer" style="flex-direction: row;">
          <button class="edit__button" onClick$={ () => onEditClick( discountProduct.id ) }> Edit </button>
          <button class="primary-button" onClick$={ () => onCreateCouponsClick( discountProduct.id ) }> Create Coupons </button>
        </section>
        <section>
          <h1 class="view__name">
            Coupons
