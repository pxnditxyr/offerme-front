...
export default component$( () => {
  ...
  const onEditClick = $( ( id : string ) => nav( `/seller/modules/products/update/${ btoa( id ) }` ) )
  const onViewClick = $( ( id : string ) => nav( `/seller/modules/products/view/${ btoa( id ) }` ) )
  ...
  const onSearchSubmit = $( ( event : QwikSubmitEvent<HTMLFormElement> ) => {
    ...
    nav( `/seller/modules/products?${ `search=${ target.search.value }` }` )
  } )
