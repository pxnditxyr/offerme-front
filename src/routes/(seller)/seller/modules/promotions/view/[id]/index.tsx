...
export default component$( () => {
  ...
  const onImageClick = $( ( id : string ) => {
    nav( `/seller/modules/promotion-requests/promotion-images/view/${ btoa( id ) }` )
  } )

  const onDiscountProductClick = $( ( id : string ) => {
    console.log( 'entra', id )
    nav( `/seller/modules/promotions/discount-products/view/${ btoa( id ) }` )
  } )

  return (
    <div class="view__container">
      <BackButton href="/seller/modules/promotion-requests" />
